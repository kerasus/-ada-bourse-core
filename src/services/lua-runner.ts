...
function pushJSValueToLua (L: any, value: any): void {
...
function pushParamsToLuaGlobal (L: any, params: Record<string, any>): void {
...
export function runSafeLuaScript (luaCode: string, params: Record<string, any> = {}): string {
  ...
  if ((lua.lua_gettop)(L) > 0) {
    return (lua.lua_tojsstring)(L, -1) as string
